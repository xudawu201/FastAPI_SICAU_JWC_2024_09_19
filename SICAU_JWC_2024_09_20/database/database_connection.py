...
# 使用sqlserver部署容器数据库
# database_url = 'DRIVER={ODBC Driver 18 for SQL Server};SERVER=sqlserver2022;PORT=1433;DATABASE=jxgl_all;UID=sa;PWD=sicau_jwc_sqlserver123;Encrypt=no;TrustServerCertificate=yes'
