...
class Schedule:
    ...
    def fitness(self):
        ...
        # student_time_dict = {CurStudent.name_str: [] for CurStudent in self.student_list}
    ...
    def display(self):
        ...
        for (cur_timeslot_str, cur_room_str), CurCourse in self.schedule_dict.items():
            ...
            if CurCourse is not None:
                ...
                print(f"{cur_timeslot_str} in {cur_room_str}: {CurCourse.name_str} by {CurCourse.teacher_str} (Priority: {CurCourse.priority_float}) | Enrolled: {enrolled_course_student_str}{conflict_str}")
